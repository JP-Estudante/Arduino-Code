...
const int Botao2 = 13;  //botao no pino 13
...
int tamanho = 50;       //sempre coloque o tamanho do vetor aqui nesta variável para facilitar uma mudança rápida no tamanho dele
int instrucoes[50];     //vetor de inteiros para salvar quais as instruções a serem segudas após execução
